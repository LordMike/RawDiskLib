...
namespace TestApplication
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Done with Writing, beginning Hashing of Drives, type ENTER to proceed.");
            Console.ReadLine();
            Console.Clear();
                ...
                foreach (char drive in volumeDrives)
                {
                    ...
                    try
                    {
                        using (RawDisk disk = new RawDisk(drive))
                        {
                            ...
                            Console.WriteLine("Computed MD5: {0}", BitConverter.ToString(md5.Hash).Replace("-", ""));
                        }
                    }
                    catch (Exception ex)
                    {
